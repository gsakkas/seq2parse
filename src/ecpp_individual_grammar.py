...
def main():
    ...
    grammar.update_error_grammar_with_erules(['Err_Literals -> ', 'Err_Literals -> H Literals', 'Err_Newline -> H Newline', 'Err_Open_Paren -> ', 'Err_Return_Keyword -> ', 'InsertErr -> )', 'InsertErr -> +', 'InsertErr -> :', 'InsertErr -> _NAME_', 'InsertErr -> _NUMBER_'])
    # grammar.update_error_grammar_with_erules(['Err_Close_Paren -> H Close_Paren', 'Err_Comma -> H Comma', 'Err_Literals -> ', 'Err_Literals -> H Literals', 'Err_MulDiv_Op -> H MulDiv_Op', 'Err_Newline -> H Newline', 'Err_Open_Paren -> ', 'Err_Open_Sq_Bracket -> ', 'Err_Return_Keyword -> ', 'Err_Star_Op -> ', 'InsertErr -> %', 'InsertErr -> )', 'InsertErr -> *', 'InsertErr -> +', 'InsertErr -> ,', 'InsertErr -> -', 'InsertErr -> :', 'InsertErr -> _NAME_', 'InsertErr -> _NUMBER_', 'InsertErr -> for'])
