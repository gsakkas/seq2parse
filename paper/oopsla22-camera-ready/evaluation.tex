...
\begin{figure}[t]
  ...
  \resizebox{\linewidth}{!}{
    \begin{tabular}{@{}l||cccccc|cccccc@{}}
      ...
      \hline
      \textsc{AllParses}    & & 62.92\%          & 72.22\%           & \textbf{35.41\%} & 6.7 \emph{(11.3)} sec         & & & 56.40\%          & 62.20\%           & 31.36\%          & 20.8 \emph{(22.7)} sec     & \\
...
exponential explosion in parse time for larger programs. \GS{Should we explain
this more or somewhere in the technical sections?}
...
\begin{framed}
  \noindent
  35\% of \toolname's repairs are equivalent to historical repairs.
  ...
  % from (35\%), or judged better than (15\%), those produced by humans for helping debugging.
\end{framed}
