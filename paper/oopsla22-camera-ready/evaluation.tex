...
errors for \python in its entirety. All code for \toolname is publicly available
at \url{https://github.com/gsakkas/seq2parse} and we've provided a running
smaller version of \toolname on a
\href{http://seq2parse.goto.ucsd.edu/index.html}{website demo}. Next, we
...
\GS{TODO: Explain how accuracy is computed???}
...
programs and a few/a lot syntax errors to show scalabilty. Running experiments.}
