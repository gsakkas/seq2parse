...
\begin{figure}[t]
  ...
  \begin{minipage}[c]{0.46\linewidth}
    ...
    \resizebox{\linewidth}{!}{
      ...
      \end{tabular}
    } \caption{Experimental results of \toolname's repair approaches. \GS{TODO:
    Should we add end-to-end results for NoPCFG predictor? Running the
    experiments now either way.}}
