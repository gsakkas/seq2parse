...
\begin{figure}[t]
  ...
  \resizebox{\linewidth}{!}{
    \begin{tabular}{@{}l||cccccc|cccccc@{}}
      ...
      \hline
      \textsc{AllParses}    & & 61.82\%          & 72.22\%           & \textbf{33.92\%} & 23.2 sec                      & & & --               & --                & --               & --                         & \\
      \textsc{MinimumCost}  & & \textbf{94.25\%} & \textbf{94.01\%}  & 20.55\%          & 5.3 \emph{(4.9)} sec          & & & 91.63\%          & 90.89\%           & 17.89\%          & 12.9 \emph{(12.3)} sec     & \\
      \textsc{Threshold}    & & 94.19\%          & 93.42\%           & 21.19\%          & \textbf{2.1 \emph{(2.3)} sec} & & & 93.70\%          & 91.09\%           & 19.39\%          & 2.9 \emph{(3.3)} sec       & \\
    \end{tabular}
  ...
  median time for larger programs, \ie programs with more than 250 tokens.
