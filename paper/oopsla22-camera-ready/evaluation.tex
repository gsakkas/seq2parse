...
\GS{we had this part in rebuttal: "We will make available supplementary
...
\GS{we had this part in rebuttal: "We will augment the text in Section 7.1 to
explain that the MinimumCost version of Seq2Parse only retains the top \#1
(minimum cost) repair, resulting in a more efficient parser, unlike AllParses,
which is slower but retains all possible repairs and thus obtains a higher
accuracy (as shown in Section 7.3)"}
%
...
\begin{figure}[t]
  ...
  \begin{minipage}[c]{0.53\linewidth}
    ...
    \autoref{tab:seq2parse_full_results}. \GS{TODO: zoom out graph and smoothen
    by fitting a line over results}}
...
time of 5.3 seconds. \GS{TODO: Going to add median parse times for small/big
programs and a few/a lot syntax errors. Running experiments.}
