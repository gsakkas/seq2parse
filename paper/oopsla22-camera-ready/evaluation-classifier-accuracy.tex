...
\begin{figure}[t]
  % \begin{minipage}[c]{0.49\linewidth}
    ...
    \caption{
      Results of our error production rule prediction classifiers for the simple original token sequences and their abstracted versions using the PCFG. \GS{TODO: Should we add here the Abstracted results without the PCFG??? Currently running an experiment without PCFG to show the abstraction sensitivity.}
    }
