...
%
For example, state-of-the-art methods such as ~\citep{Ahmed_2021} parses and
repairs only \emph{32\%} of real student code with up to 3 syntax errors
and~\citep{Wu2020} repairs at most only \emph{58\%} of syntax errors of a
real-world dataset.
...
rules and can parse $94\%$ of our tests within $2.5$ seconds with these
...
parses and repairs erroneous programs within $20$ seconds $82\%$ of the time,
