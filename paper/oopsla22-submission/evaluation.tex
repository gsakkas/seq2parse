...
\toolname (with the \textsc{MinimumCost}
ECE-Parser) repairs 61.41\% and 58.61\% of the programs respectively within 20
seconds, and has median parse times of 7.0 and 13.6 seconds respectively. The
50 most popular rules admit parsing fewer programs quickly than the do the 20
most popular. 
% ECE-Parser, but the extra number of error rules aids the ECE-Parser to parse programs that the other version could not.
