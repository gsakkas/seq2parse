...
%For those fixes that 
%this is primarily caused by the human programmer deleting the buggy line or making
%a change that appears to be a programming mistake. Figure~\ref{fig:user_study_examples} contains an example
%of two such repairs. In the first one, the program was missing parentheses around
%the print statement. Instead of fixing this issue, the programmer simply deleted
%the statement, perhaps out of confusion or frustration. \toolname, however, correctly
%fixes the bug. 
