...
%
\Cref{algo:training-classifier-algo} presents how we use a (probabilistic)
...
define the $\trainsym$ procedure in \Cref{algo:training-classifier-algo} that is
...
We now describe our approach for $\systemsym$ in \Cref{algo:ecep-algo}. This is
